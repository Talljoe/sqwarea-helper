...
* Override the default troop counts for reinforcement to keep from accidentally sending half your troops to a square.
* Override the default troop counts for attacks.
